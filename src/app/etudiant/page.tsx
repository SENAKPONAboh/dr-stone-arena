    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 pb-10 transition-colors duration-300">
      ...
      <main className="max-w-5xl mx-auto px-4 mt-6">
        ...
        <a 
          ...
          className="block w-full bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white p-4 rounded-2xl shadow-md flex items-center justify-center gap-3 mb-6 transition-all group"
        >
          ...
          <span className="font-extrabold uppercase tracking-wide">Rejoindre la communauté WhatsApp</span>
        </a>
