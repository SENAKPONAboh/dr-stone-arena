...
export async function GET() {
  try {
    const curriculum = [
      ...
      // --- ANNÉE 3 ---
      { year: 3, subject: "Immunologie", chapters: ["Introduction à l'immunologie", "L'immunité innée", "Organes et cellules du système immunitaire", "Antigènes", "Anticorps", "Réactions Ag-Ac", "Système du complément", "Complexe majeur d'histocompatibilité", "Interactions cellulaires", "Les réactions d'hypersensibilité", "Mécanismes d'action des vaccins"] },
      { year: 3, subject: "Anatomie pathologique", chapters: ["Moyens et objectifs de l'anapath", "Lésions élémentaires des cellules, tissus et organes", "Le système circulatoire et ses troubles", "Réactions inflammatoire et les inflammations", "Pathologie tumorale"] },
      { year: 3, subject: "Sémiologie urologique", chapters: ["Douleur en urologie", "Les modifications de la miction", "Les syndromes urinaires"] },
      { year: 3, subject: "Sémiologie neurochirurgicale", chapters: ["Hypertension intracrânienne", "Hémorragie méningé", "Les compressions médullaires lentes", "Le syndrome de la queue du cheval", "Le syndrome frontal"] },
      { year: 3, subject: "Sémiologie vasculaire", chapters: ["Généralités sur la sémiologie vasculaire", "Sémiologie artérielle, veineuse et lymphatique", "Les syndromes vasculaires"] },
      { year: 3, subject: "Sémiologie gynécologique", chapters: ["La consultation en gynécologie", "Les démarches diagnostiques en gynécologie obstétrique", "Les affections courantes: torsions d'annexes", "Les fibromes utérin"] },
      ...
      { year: 3, subject: "Sémiologie thoracique", chapters: ["Traumatisme thoracique fermé", "Les plaies thoraciques", "Les syndromes mediastinaux", "Les malformations de la paroi thoracique", "Introduction à la chirurgie thoracique"] },
      { year: 3, subject: "Sémiologie traumatologique", chapters: ["Sémiologie de l'appareil locomoteur"] },
      { year: 3, subject: "Pharmacologie", chapters: ["Introduction à la pharmacologie générale", "Development du médicament", "Résorption", "Distribution", "Biotransformation", "Cibles biologiques des médicaments- classification", "Les canaux, pompes, transporteurs ioniques", "Les enzymes et autres protéines", "Les récepteurs", "Le système cholinergique"] },
    ...
    return NextResponse.json({ 
      success: true, 
      message: `Cursus médical complet injecté avec succès !`, 
